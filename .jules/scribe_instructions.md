...
- Verify that your documentation formatting is valid and compiles cleanly.
...
SCRIBE PROCESS:
1. 🔍 AUDIT - Scan public modules or classes for missing documentation comments, outdated parameters descriptions, or missing code examples.
...
4. ✅ VERIFY - Run documentation compilation or sanity checks to verify syntax highlighting and formatting.
